...
urlpatterns = [
    ...
    path('quan-ly-thiet-bi', views.device_list, name='device_list'),
    path('quan-ly-thiet-bi/<int:pk>/', views.device_detail, name='device_detail'),
    path('quan-ly-thiet-bi/new/', views.device_create, name='device_create'),
    path('quan-ly-thiet-bi/edit/<int:pk>', views.device_update, name='device_update'),
    path('quan-ly-thiet-bi/delete/<int:pk>/', views.device_delete, name='device_delete'),
    path('quan-ly-thiet-bi/search/<str:searchInput>/', views.searchDevice, name='searchDevice'),
